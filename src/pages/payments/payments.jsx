    ...
    return <article id="payments">
        ...
        <div className="second">
            ...
            <div className="option">
                ...
                <p>UN SOLO PAGO: $1&apos;225.000<br /><strong>FECHA: 1/04/25</strong></p>
            </div>
            ...
            <div className="option">
                ...
                <p>CUOTA 1: $225.000<br /><strong>FECHA 1: 1/04/25</strong><br />CUOTA 2 Y 3: $500.000 CADA UNA<br /><strong>FECHA 2: 1/07/25</strong><br /><strong>FECHA 3: 1/10/25</strong></p>
            </div>
